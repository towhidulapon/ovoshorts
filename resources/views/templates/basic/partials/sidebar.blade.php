<div class="sidebar-menu">
    <div class="sidebar-menu__inner">
        ...
        <div class="sidebar-logo">
            <a href="index.html" class="side-sm-logo"><img src="assets/images/logo/favicon.png" alt="logo"></a>
            <a href="index.html" class="sidebar-logo__link"><img src="assets/images/logo/logo.png" alt="logo"></a>
        </div>
        <div class="sidebar-search">
            <div class="input-group-custom">
                <span class="input-group-custom__icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <path d="M11.5 2C16.75 2 21 6.25 21 11.5C21 16.75 16.75 21 11.5 21C6.25 21 2 16.75 2 11.5C2 7.8 4.11 4.6 7.2 3.03" stroke="white" stroke-width="1.5" stroke-linecap="round"
        ...
        <ul class="sidebar-menu-list">
            <li class="sidebar-menu-list__item">
                <a href="index.html" class="sidebar-menu-list__link">
                    <span class="icon">
                ...
                <a href="explore.html" class="sidebar-menu-list__link">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                            <path
                                d="M15.654 8.59888L7.54107 10.9169C7.3601 10.9686 7.34424 11.2189 7.51724 11.293L11.3168 12.9212C11.4349 12.9718 11.5289 13.0658 11.5795 13.1838L13.2079 16.9829C13.282 17.1559 13.5323 17.14 13.584 16.9591L15.9012 8.84611C15.9443 8.69525 15.8048 8.55578 15.654 8.59888Z"
            ...
            <li class="sidebar-menu-list__item">
                <a href="#" class="sidebar-menu-list__link">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                            <path
                                d="M12.75 17.139C12.75 15.6053 13.8687 14.2501 15.5 14.2501C16.0855 14.2501 16.6247 14.3787 17.0953 14.6732C17.2418 14.7649 17.3764 14.8694 17.5 14.9851C17.6236 14.8694 17.7582 14.7649 17.9047 14.6732C18.3753 14.3787 18.9145 14.2501 19.5 14.2501C21.1313 14.2501 22.25 15.6053 22.25 17.139C22.25 18.9837 21.0327 20.3905 19.9821 21.2721C19.4504 21.7184 18.254 22.4224 17.835 22.669L17.8152 22.6807C17.6153 22.7733 17.3843 22.7731 17.1843 22.6804L17.165 22.6691C16.7464 22.4228 15.5498 21.7185 15.0179 21.2721C13.9673 20.3905 12.75 18.9837 12.75 17.139Z"
                                fill="currentColor" />
                            <path
                                d="M11.5 17.1389C11.5 15.6298 12.3021 14.1646 13.6455 13.4508C12.9212 12.9913 12.1155 12.6488 11.2549 12.4495C13.2914 11.7274 14.75 9.78405 14.75 7.5C14.75 4.60051 12.3995 2.25 9.5 2.25C6.6005 2.25 4.25 4.60051 4.25 7.5C4.25 9.78405 5.70857 11.7274 7.7451 12.4495C4.31022 13.2447 1.75 16.3234 1.75 20C1.75 20.4142 2.08579 20.75 2.5 20.75H12.7905C12.0806 19.8117 11.5 18.6015 11.5 17.1389Z"
                                fill="currentColor" />
                        </svg>
                    </span>
            ...
            <li class="sidebar-menu-list__item">
                <a href="#" class="sidebar-menu-list__link">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                            <path d="M15.5 11.5C15.5 9.567 13.933 8 12 8C10.067 8 8.5 9.567 8.5 11.5C8.5 13.433 10.067 15 12 15C13.933 15 15.5 13.433 15.5 11.5Z" stroke="CurrentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M15.4825 11.8499C15.8045 11.9475 16.146 12 16.4998 12C18.4328 12 19.9998 10.433 19.9998 8.5C19.9998 6.567 18.4328 5 16.4998 5C14.6849 5 13.1926 6.3814 13.0171 8.15013"
                                stroke="CurrentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M10.9827 8.15013C10.8072 6.3814 9.31492 5 7.5 5C5.567 5 4 6.567 4 8.5C4 10.433 5.567 12 7.5 12C7.85381 12 8.19535 11.9475 8.51727 11.8499" stroke="CurrentColor" stroke-width="2"
                                stroke-linecap="round" stroke-linejoin="round" />
            ...
            <li class="sidebar-menu-list__item">
                <a href="#" class="sidebar-menu-list__link">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                            <path d="M19.5 3H4.5C3.39543 3 2.5 3.89543 2.5 5V20C2.5 21.1046 3.39543 22 4.5 22H19.5C20.6046 22 21.5 21.1046 21.5 20V5C21.5 3.89543 20.6046 3 19.5 3Z" stroke="CurrentColor"
            ...
            <li class="sidebar-menu-list__item has-sidebar">
                <a href="#" class="sidebar-menu-list__link">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                            <path d="M7 14.5L9.79289 11.7071C10.1834 11.3166 10.8166 11.3166 11.2071 11.7071L12.7929 13.2929C13.1834 13.6834 13.8166 13.6834 14.2071 13.2929L17 10.5" stroke="CurrentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M21.5 5V20C21.5 21.1046 20.6046 22 19.5 22H4.5C3.39543 22 2.5 21.1046 2.5 20V5C2.5 3.89543 3.39543 3 4.5 3H19.5C20.6046 3 21.5 3.89543 21.5 5Z" stroke="CurrentColor"
            ...
            <li class="sidebar-menu-list__item">
                <a href="#" class="sidebar-menu-list__link">
                    <span class="icon">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                            <path d="M20 21.5C21.1046 21.5 22 20.6046 22 19.5V13.5C22 12.3954 21.1046 11.5 20 11.5H4C2.89543 11.5 2 12.3954 2 13.5V19.5C2 20.6046 2.89543 21.5 4 21.5H20Z" stroke="CurrentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            ...
                            <path d="M5 14.5V18.5H6.5M19 18.5H17V16.5M17 16.5V14.5H19M17 16.5H18.5M9 14.5V18.5M11.5 14.5L13 18.5L14.5 14.5" stroke="CurrentColor" stroke-width="2" stroke-linecap="round"
                                stroke-linejoin="round" />
                        </svg>
                    </span>
