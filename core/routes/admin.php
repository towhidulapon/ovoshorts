...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::get('verified', 'verifiedUsers')->name('verified');
        ...
        Route::get('verification-pending', 'verificationPendingUsers')->name('verification.pending');
        Route::get('verification-data/{id}', 'verificationDetails')->name('verification.details');
    ...
    Route::controller('VerificationController')->prefix('verification')->name('verification.')->group(function () {
        ...
        Route::post('verification-setting', 'settingUpdate')->name('setting.update');
