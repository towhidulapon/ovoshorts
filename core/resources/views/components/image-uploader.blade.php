            ...
            <div class="image-upload__content">
                ...
                <div class="d-flex flex-column flex-wrap  gap-1 gap-md-0 align-items-center justify-content-center">
                    <p class="uploade-message">
                        <label class="text--primary cursor-pointer text-decoration-underline" for="{{ $id }}">
...
@push('script')
    <script>
        (function($) {
            ...
            $('.image-upload__placeholder').on('click', function(e) {
                if (e.target.tagName !== 'INPUT' && e.target.tagName !== 'LABEL') {
                $(this).find('.image-upload-input').click();
                }
            });

            $('.image-upload__placeholder').on('dragover', function(e) {
                e.preventDefault();
                $(this).addClass('dragging');
            });

            $('.image-upload__placeholder').on('dragleave', function(e) {
                e.preventDefault();
                $(this).removeClass('dragging');
            });

            $('.image-upload__placeholder').on('drop', function(e) {
                e.preventDefault();
                $(this).removeClass('dragging');
