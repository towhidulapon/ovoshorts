...
<div id="confirmationModal" class="modal fade @if (!$isFrontend)  @endif" tabindex="-1" role="dialog" data-bs-backdrop="static" data-bs-keyboard="false">
            ...
            <form method="POST">
                ...
                <div class="modal-body  @if (!$isFrontend) py-4 px-5 @endif">
                    ...
                    <div class="d-flex gap-3 flex-wrap pt-2 pb-3">
                        <div class="flex-fill">
                            <button type="button" class="btn w-100 @if (!$isFrontend) btn--secondary btn-large @else btn-dark @endif " data-bs-dismiss="modal">
                                <i class="fa-regular fa-circle-xmark"></i> @lang('No')
                            </button>
                        </div>
                        <div class="flex-fill">
                            <button type="submit" class="btn w-100  btn--primary  @if (!$isFrontend) btn-large @endif">
