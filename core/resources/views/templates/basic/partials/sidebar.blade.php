@if (request()->routeIs('user.message.index'))
    <div class="sidebar-menu show-by-default">
@else
        ...
        <div class="sidebar-menu__inner">
            ...
            <ul class="sidebar-menu-list">
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('home') }}" class="sidebar-menu-list__link {{ request()->routeIs('home') ? 'active' : '' }}">
                        <span class="icon">
                ...
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('explore') }}" class="sidebar-menu-list__link {{ request()->routeIs('explore') ? 'active' : '' }}">
                        <span class="icon">
                ...
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('user.friend.following') }}" class="sidebar-menu-list__link {{ request()->routeIs('user.friend.following') ? 'active' : '' }}">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('user.friend.index') }}" class="sidebar-menu-list__link {{ request()->routeIs('user.friend.index') ? 'active' : '' }}">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
                ...
                <li class="sidebar-menu-list__item">
                    <a href="{{ route('user.short.upload.index') }}" class="sidebar-menu-list__link {{ request()->routeIs('user.short.upload.index') ? 'active' : '' }}">
                        <span class="icon">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="25" viewBox="0 0 24 25" fill="none">
        ...
        <div class="sidebar-left">
            <div class="sidebar-left__header">
                <div class="sidebar-left__header-top">
                    <h4 class="titel">@lang('Notifications')</h4>
            ...
            <div class="sidebar-left__body">
                @if ($groupedNotifications['today']->isNotEmpty())
                    <span class="sidebar-left__title">@lang('Today')</span>
                                ...
                                <div class="notification-item__content">
                                    ...
                                    <span class="desc">
                                        @if ($notification['type'] === 'like')
                                            @lang('Liked your video')
                                        @elseif ($notification['type'] === 'follower')
                                            @lang('Started following you')
                                        @elseif ($notification['type'] === 'star')
                                            @lang('Sent you :stars stars', ['stars' => $notification['stars']])
                                        @else
                                            @lang('Commented on your video'): {{ Str::limit($notification['comment'], 30) }}
                                        @endif
                ...
                @if ($groupedNotifications['this_month']->isNotEmpty())
                    <span class="sidebar-left__title">@lang('This Month')</span>
