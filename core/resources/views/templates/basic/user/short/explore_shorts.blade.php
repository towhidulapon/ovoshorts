    ...
    <div class="explore-item">
        <a href="{{ route('user.short.view', $userShort->id) }}" class="explore-item__link">
            <div class="explore-item__video">
                <video class="video-player" playsinline preload="metadata" data-video_id="223" controls poster="{{ getImage(getFilePath('coverImage') . '/' . $userShort->cover_image, getFileSize('coverImage')) }}">
                ...
                <button class="explore-action">
                    ...
                    <span class="text">{{ showFormatCount($userShort->likes->count()) }}</span>
                </button>
            </div>
        </a>
