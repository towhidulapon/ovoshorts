                                        ...
                                        <div class="right-sidebar__body">
                                            <div class="tab-content" id="pills-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab" tabindex="0">
                                                    <div id="shorts-skeleton" class="d-none">
                                                        <div class="row g-3">
                                                            @for ($i = 0; $i <= 9; $i++)
    ...
    <script>
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                // Load comments when Comments tab is shown
                $('#pills-home-tab').on('shown.bs.tab', function () {
                    console.log('Comments tab shown, loading comments for shortId:', currentShortId);
                    currentPage = 1;
                    hasMoreComments = true;
                ...
                // Trigger initial load if Comments tab is active
                if ($('#pills-home-tab').hasClass('active')) {
                    loadComments(currentShortId);
                }
                ...
                $('.right-sidebar__body').on('scroll', function () {
                    ...
                    if (
                        ...
                        hasMoreComments &&
                        currentShortId &&
                        $('#pills-home').hasClass('active')
                    ) {
                        console.log('Loading more comments, page:', currentPage);
                ...
                $(document).on('click', '.like-btn', function (e) {
                    ...
                    var $button = $(this);
                    var $countElement = $button.closest('.cmn-button-item, .explore-item').find(
                        '.like-count');
                    var shortsId = $button.data('shorts-id');
                    var shortsOwnerId = $button.data('shorts-owner-id');
                    var formData = new FormData();
                            ...
                            if (response.data.success) {
                                ...
                                if (platform === 'link') {
                                    ...
                                    window.open('https://t.me/share/url?url=' +
                                        encodeURIComponent(response.data.share_url),
                                        '_blank');
                                } else if (platform === 'whatsapp') {
                                    window.open('https://wa.me/?text=' + encodeURIComponent(
                                        response.data.share_url), '_blank');
                                } else if (platform === 'facebook') {
                                    window.open(
