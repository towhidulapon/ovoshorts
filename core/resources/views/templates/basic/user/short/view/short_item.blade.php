<div class="explore-item">
    <a href="{{ route('user.short.view', $short->id) }}" class="explore-item__link">
        <div class="explore-item__video">
            ...
            <button class="explore-action like-btn {{ $short->isLiked ? 'liked' : '' }}" data-shorts-id="{{ $short->id }}" data-shorts-owner-id="{{ $short->user_id }}">
                <span class="icon">
                ...
                <span class="text like-count">{{ showFormatCount($short->likes_count) }}</span>
            </button>
        </div>
    </a>
</div>