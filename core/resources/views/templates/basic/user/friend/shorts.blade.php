            ...
            <div class="explore-item">
                <a href="{{ route('user.short.view', $short->id) }}" class="explore-item__link">
                    <div class="explore-item__video">
                        <video class="video-player" playsinline preload="metadata" data-video_id="{{ $short->id }}" controls poster="{{ getImage(getFilePath('coverImage') . '/' . $short->cover_image) }}">
                ...
                <a href="#" class="explore-item__author">
                    ...
                    <span class="explore-item__author__name">
                        {{$short?->user?->username}}
                    </span>
                </a>
            </div>
