    ...
    <div class="body__wrapper-container">
        ...
        <div class="author-profile pt-4">
            <div class="author-profile__thumb">
                <img src="{{ $user->image ? getImage(getFilePath('userProfile') . '/' . $user->image, getFileSize('userProfile')) : asset('assets/images/avatar.jpg') }}"
            ...
            <div class="author-profile__content">
                ...
                <div class="author-profile__btn">
                    ...
                    <a href="{{ route('user.notification.index') }}" class="profile-action-btn"><svg
