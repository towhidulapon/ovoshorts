...
@section('content')
    <div class="container">
        <div class="row justify-content-center mt-4">
            <div class="col-md-12">
                <div class="text-end">
                    <a href="{{ route('ticket.index') }}" class="btn btn--sm btn--base mb-3">@lang('My Support Ticket')</a>
                </div>
                    ...
                    <div class="card-body">
                        <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-9">
                                    <button type="button" class="btn btn--sm btn-dark  addAttachment my-2"> <i
                                ...
                                <div class="col-md-3">
                                    <button class="btn btn--sm btn--base w-100 my-2" type="submit"><i
