    ...
    @if (gs('registration'))
                                ...
                                <div class="login-form__wrapper">
                                    ...
                                    <ul class="nav nav-pills mb-3 custom--tab" id="pills-tab" role="tablist">
                                        <li class="nav-item" role="presentation">
                                            <button class="nav-link active" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile"
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="input-group-custom">
                                                                <span class="input-group-custom__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                                                        <path d="M16 14C14.3431 14 13 15.3431 13 17V18H19V17C19 15.3431 17.6569 14 16 14Z" fill="Hsl(var(--primary))" />
                                                                        <path d="M16 12C17.6569 12 19 10.6569 19 9C19 7.34315 17.6569 6 16 6C14.3431 6 13 7.34315 13 9C13 10.6569 14.3431 12 16 12Z" fill="Hsl(var(--primary))" />
                                                                        <path d="M8 14C6.34315 14 5 15.3431 5 17V18H11V17C11 15.3431 9.65685 14 8 14Z" fill="Hsl(var(--primary))" />
                                                                        <path d="M8 12C9.65685 12 11 10.6569 11 9C11 7.34315 9.65685 6 8 6C6.34315 6 5 7.34315 5 9C5 10.6569 6.34315 12 8 12Z" fill="Hsl(var(--primary))" />
                                                                    </svg>
                                                                </span>
                                                                <input class="input-group-custom__input form-control form--control" type="text" name="referBy" id="referenceBy" value="{{ session()->get('reference') }}" readonly placeholder="@lang('Reference by')">
                                                            </div>
                                                        </div>
                                                    @endif
                                                    <div class="col-md-6 form-group">
                                                        <div class="input-group-custom">
                                                            ...
                                                            <input class="input-group-custom__input form-control form--control" type="text" placeholder="First Name" name="firstname" value="{{ old('firstname') }}"
                                                                required>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 form-group">
                                                    ...
                                                    <div class="col-sm-12 form-group">
                                                        <div class="input-group-custom">
                                                            ...
                                                            <input class="input-group-custom__input form-control form--control"
                                                            id="password_confirmation" type="password" placeholder="Confirm Password" name="password_confirmation" required>
        ...
        $policyPages = getContent('policy_pages.element', false, orderById: true);
                                ...
                                <div class="have-account text-center">
                                    <p class="have-account__text">@lang('Already have an Account?') <a href="{{ route('user.login') }}" class="have-account__link text--base fw-700">@lang('Sign In')</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
