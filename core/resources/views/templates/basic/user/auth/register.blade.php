...
@section('app-content')
    @if (gs('registration'))
        <section class="account position-relative bg-img"
            data-background-image="{{ asset($activeTemplateTrue . 'images/account-bg.png') }}">
                            ...
                            <div class="account-form login-form">
                                <div class="login-form__wrapper">
                                    <div class="account-form__content">
                                        <h3 class="account-form__title mb-2 text-center">@lang('Register to')
                                            {{ gs('site_name') }}</h3>
                                    </div>
                                                ...
                                                <div class="row">
                                                            ...
                                                            <div class="input-group-custom">
                                                                <span class="input-group-custom__icon">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24"
                                                                        ...
                                                                        <path
                                                                            d="M16 14C14.3431 14 13 15.3431 13 17V18H19V17C19 15.3431 17.6569 14 16 14Z"
                                                                            fill="Hsl(var(--primary))" />
                                                                        <path
                                                                            d="M16 12C17.6569 12 19 10.6569 19 9C19 7.34315 17.6569 6 16 6C14.3431 6 13 7.34315 13 9C13 10.6569 14.3431 12 16 12Z"
                                                                            fill="Hsl(var(--primary))" />
                                                                        <path
                                                                            d="M8 14C6.34315 14 5 15.3431 5 17V18H11V17C11 15.3431 9.65685 14 8 14Z"
                                                                            fill="Hsl(var(--primary))" />
                                                                        <path
                                                                ...
                                                                <input
                                                                    class="input-group-custom__input form-control form--control"
                                                                    type="text" name="referBy" id="referenceBy"
                                                                    value="{{ session()->get('reference') }}" readonly
                                                                    placeholder="@lang('Reference by')">
                                                            </div>
                                                        </div>
                                                    @endif
                                                    ...
                                                    <div class="col-sm-12 form-group">
                                                        <div class="input-group-custom">
                                                            ...
                                                            <input
                                                                class="input-group-custom__input form-control form--control checkUser"
                                                    ...
                                                    <div class="col-sm-12 form-group">
                                                        <div class="input-group-custom">
                                                            ...
                                                            <x-strong-password />
                                                            <span
                                                                class="password-show-hide fas toggle-password fa-eye-slash"
                                                                id="#password"></span>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-12 form-group">
                                ...
                                <div class="have-account text-center">
                                    <p class="have-account__text">@lang('Already have an Account?') <a href="{{ route('user.login') }}"
                                            class="have-account__link text--base fw-700">@lang('Sign In')</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
