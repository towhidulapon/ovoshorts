                            ...
                            <div class="login-form__wrapper">
                                ...
                                <ul class="nav nav-pills mb-3 custom--tab" id="pills-tab" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">@lang('QR-code')</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">@lang('Email')</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">@lang('Other')</button>
                                    </li>
                                </ul>
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab" tabindex="0">
                                        <div class="form-qr-code text-center">
                                            <div id="login-qr-canvas" class="qrcode-canvas-style"></div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12 form-group">
                                                    <div class="input-group-custom">
                                                        ...
                                                        <input class="input-group-custom__input form-control form--control" type="text" placeholder="Someone@example.com" name="username" value="{{ old('username') }}" required>
                                                    </div>
                                                </div>
...
@push('script')
    ...
    <script>
        ...
        (function ($) {
            ...
            function loginQrInit() {
                const canvasElement = document.getElementById("login-qr-canvas");
