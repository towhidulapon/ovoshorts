                    ...
                    <div class="alert alert--danger mb-3" role="alert">
                        ...
                        <div class="alert__content">
                            ...
                            <p class="alert__desc" class="alert__desc">
                                ...
                                <a href="javascript::void(0)" class="alert__link" data-bs-toggle="modal" data-bs-target="#kycRejectionReason">@lang('Click here')</a> @lang('to show the reason').
                ...
                @elseif(auth()->user()->kv == Status::KYC_UNVERIFIED)
                    <div class="alert alert--info mb-3" role="alert">
                        ...
                        <div class="alert__content">
                            ...
                            <p class="alert__desc">{{ __(@$kyc->data_values->required) }} <a href="{{ route('user.kyc.form') }}">@lang('Click Here to Submit Documents')</a>
                            </p>
                        </div>
                    </div>
                @elseif(auth()->user()->kv == Status::KYC_PENDING)
                    <div class="alert alert--warning mb-3" role="alert">
                        ...
                        <div class="alert__content">
                            ...
                            <p class="alert__desc">{{ __(@$kyc->data_values->pending) }} <a href="{{ route('user.kyc.data') }}">@lang('See KYC Data')</a>
                            </p>
                        </div>
