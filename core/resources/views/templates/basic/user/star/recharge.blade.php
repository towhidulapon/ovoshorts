                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-10">
                            <div class="custom--card">
                                <div class="card-body">
                                    <form action="{{ route('user.star.store.info') }}" method="post" class="deposit-form">
                                        @csrf
                                        ...
                                        <div class="gateway-card">
                                            <div class="row justify-content-center gy-sm-4 gy-3">
                                                <div class="col-12">
                                                    <h5 class="payment-card-title">@lang('Recharge')</h5>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="payment-system-list is-scrollable gateway-option-list">
                                                        ...
                                                        <label for="main-balance" class="payment-item gateway-option">
                                                            ...
                                                            <input class="payment-item__radio gateway-input" id="main-balance"
                                                                hidden type="radio" name="gateway" value="main-balance"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="payment-system-list">
                                                            ...
                                                            <div class="deposit-info__input">
                                                                <div class="deposit-info__input-group input-group">
                                                                    ...
                                                                    <input type="text" class="form-control form--control amount"
                                                                        ...
                                                                        value="{{ getAmount($star->price) }}" autocomplete="off"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="deposit-info">
                                                            ...
                                                            <div class="deposit-info__input">
                                                                <p class="text"><span
                                                                        class="gateway-limit">@lang('0.00')</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="deposit-info">
