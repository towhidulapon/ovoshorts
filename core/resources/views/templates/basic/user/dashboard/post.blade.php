    ...
    <div class="dashboard-body">
        ...
        <div class="dashboard-action-header flex-wrap gap-2">
            <div class="input-group-custom">
                ...
                <form action="">
                    <input class="input-group-custom__input form-control form--control" type="search" name="search" value="{{ request()->search }}" placeholder="@lang('Search for post description')">
                </form>
            </div>
            ...
            <div class="filters-wrapper">
                    ...
                    <button class="filter-btn">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <g clip-path="url(#clip0_2116_1041)">
                                <path d="M3.3335 5H16.6668" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M5.8335 10H14.1668" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8.3335 15H11.6668" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </g>
                            <defs>
                    ...
                    <div class="common-filter__dropdown">
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" id="views-1k" type="radio" name="views-sort" value="views-desc">
                                <label class="form-check-label" for="views-1k">@lang('Most > Least')</label>
                            </div>
                        </div>
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="views-sort" value="views-asc" id="views-1k-10k">
                                <label class="form-check-label" for="views-1k-10k">@lang('Least > Most')</label>
                            </div>
                        </div>
                        <div class="privacy-actions">
                            <button class="clear-btn btn btn--danger btn--sm">@lang('Clear')</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="common-filter">
                    ...
                    <div class="common-filter__dropdown">
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="likes-sort" value="likes-desc" id="likes-1k">
                                <label class="form-check-label" for="likes-1k">@lang('Most > Least')</label>
                            </div>
                        </div>
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="likes-sort" value="likes-asc" id="likes-1">
                ...
                <div class="common-filter">
                    ...
                    <div class="common-filter__dropdown">
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="comments-sort" value="comments-desc" id="comments-views">
                                <label class="form-check-label" for="comments-views">@lang('Most > Least')</label>
                            </div>
                        </div>
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="comments-sort" value="comments-asc" id="comments-comment1">
                ...
                <div class="common-filter">
                    ...
                    <div class="common-filter__dropdown">
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="privacy-sort" value="privacy-asc" id="privacy-views">
                                <label class="form-check-label" for="privacy-views">@lang('Everyone')</label>
                            </div>
                        </div>
                        <div class="common-filter__dropdown-item">
                            <div class="form--check">
                                <input class="form-check-input sort-filter" type="radio" name="privacy-sort" value="privacy-desc" id="privacy-comment2">
                    ...
                    success: function (response) {
                        if (response.data.success) {
                            ...
                            if (response.data.new_privacy_value == 1) {
                                $dropdownMenu.append(`<button class="dropdown-item" data-value="2">Only Me</button>`);
                            } else {
                                $dropdownMenu.append(`<button class="dropdown-item" data-value="1">Everyone</button>`);
                            }
