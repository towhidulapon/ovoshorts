    ...
    <div class="row responsive-row">
        <div class="form-group col-md-12">
            <div class="alert alert--danger p-3">
                @lang('Please Remember, Be very careful about changing storage or changing FTP host, Because if you change setting, make sure you copy all file directory of uploaded shorts to your new FTP or LOCAL storage. Otherwise shorts won\'t be shown to the site. e.g: Change LOCAL To FTP, then copy all your directory of shorts to your FTP directory and FTP to LOCAL ( assets/shorts). And if you don\'t enable any storage, the shorts will be uploaded to your local storage.')
            </div>
        </div>
