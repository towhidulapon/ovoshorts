        ...
        <x-admin.ui.card>
            <x-admin.ui.card.body>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-sm-6">
                        <label> @lang('Short Approval')</label>
                        <select class="select2 form-control" name="short_approval" data-minimum-results-for-search="-1">
                            <option value="0" @selected(gs('short_approval') == Status::SHORT_PENDING)>@lang('Manually')</option>
                            <option value="1" @selected(gs('short_approval') == Status::SHORT_APPROVE)>@lang('Automatic')</option>
                        </select>
                    </div>
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>@lang('View Interval')</label>
                            <span data-bs-toggle="tooltip" title="Set the interval for counting views. A repeated user’s view will be counted again only after this interval.">
                                <i class="las la-question-circle"></i>
                            </span>
                            <div class="input-group">
                                <input class="form-control" type="text" name="view_interval" required value="{{ gs('view_interval') }}">
                                <span class="input-group-text">
                                    @lang('Seconds')
                                </span>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>@lang('Verification Price')</label>
                            <div class="input-group">
                                <input class="form-control" type="text" step="any" name="verification_price" required value="{{ getAmount(gs('verification_price')) }}">
                                <span class="input-group-text">
                                    {{ gs('cur_text') }}
                                </span>
                            </div>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>@lang('Star Price')</label>
                            <span data-bs-toggle="tooltip" title="Set the price for a single star.">
                                <i class="las la-question-circle"></i>
                            </span>
                            <div class="input-group">
                                <input class="form-control" type="text" step="any" name="star_price" required value="{{ getAmount(gs('star_price')) }}">
                                <span class="input-group-text">
                                    {{ gs('cur_text') }}
                                </span>
                            </div>
