...
class AdminController extends Controller
{
    ...
    public function dashboard()
    {
        ...
        $widget['total_shorts']   = (clone $shortsQuery)->count();
        $widget['public_shorts']  = (clone $shortsQuery)->publicShort()->count();
        $widget['private_shorts'] = (clone $shortsQuery)->privateShort()->count();
        $widget['draft_shorts']   = (clone $shortsQuery)->draftShorts()->count();
    ...
    public function depositAndWithdrawReport(Request $request)
    {
        ...
        for ($i = 0; $i < $timePeriod->take; $i++) {
            ...
            $withdrawal = $deposits->where('date', $withdrawals)->first();
