...
class GeneralSettingController extends Controller
{
    ...
    public function generalUpdate(Request $request)
    {
        $request->validate([
            ...
            'short_approval'      => 'required|in:0,1',
            'view_interval'       => 'required|integer',
            'referral_commission' => 'required|numeric|gte:0',
            'verification_price'  => 'required|numeric|gte:0',
            'star_price'          => 'required|numeric|gte:0',
        ]);
        ...
        $general->short_approval      = $request->short_approval;
        $general->view_interval       = $request->view_interval;
        $general->referral_commission = $request->referral_commission;
        $general->verification_price  = $request->verification_price;
        $general->star_price          = $request->star_price;
        $general->save();
